...
from blacklisted_labels import get_blacklisted_labels

# initializing Flask application
app = Flask(__name__)

# path to the Google Cloud service account key, override with an env variable
KEY_PATH = os.environ.get("GOOGLE_VISION_KEY_PATH", "service-account.json")
